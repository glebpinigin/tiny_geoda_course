...
```{r fig.cap= "Opening the dataset", echo = F}
knitr::include_graphics("images/2_1_Opening_the_dataset.png")
```

```{r fig.cap= "Boston Housing 1970s", echo = F}
knitr::include_graphics("images/2_2_Boston_Housing_1970s.png")
```
...
```{r fig.cap= "Storing data in GIS", echo = F}
knitr::include_graphics("images/2_3_Storing_data_in_GIS.png")
```
...
```{r fig.cap= "Types of graphics in GeoDa", echo = F}
knitr::include_graphics("images/2_4_Types_of_graphics_in_GeoDa.png")
```
...
```{r fig.cap= "Creating Histogram in GeoDa", echo = F}
knitr::include_graphics("images/2_5_Creating_Histogram_in_GeoDa.png")
```
...
```{r fig.cap= "Creating Box plot in GeoDa", echo = F}
knitr::include_graphics("images/2_6_Creating_Boxplot_in_GeoDa.png")
```
...
```{r fig.cap= "Creating Scatterplot and Scatterplot Matrix in GeoDa", echo = F}
knitr::include_graphics("images/2_7_Creating_Scatterplot_and_Scatterplot_Matrix_in_GeoDa.png")
```

```{r fig.cap= "Creating 3D Scatterplot in GeoDa", echo = F}
knitr::include_graphics("images/2_8_Creating_3D_Scatterplot_in_GeoDa.png")
```
...
```{r fig.cap= "Creating Bubble Chart in GeoDa", echo = F}
knitr::include_graphics("images/2_9_Creating_a_Bubble_Chart_in_GeoDa.png")
```
...
```{r fig.cap= "Creating Parallel coordinates plot in GeoDa", echo = F}
knitr::include_graphics("images/2_10_Creating_a_Parallel_coordinates_plot_in_GeoDa.png")
```
...
```{r fig.cap= "Creating a Conditional plot in GeoDa", echo = F}
knitr::include_graphics("images/2_11_Creating_a_Conditional_plot_in_GeoDa.png")
```
