...
```{r fig.cap= "How objects can be related to each other in a map", echo = F, out.width = 600}
knitr::include_graphics("images/1_topology.png")
```
...
```{r fig.cap= "Simple geometry types and graphic variables: building blocks of map symbols", echo = F, out.width = 600}
knitr::include_graphics("images/1_primitives.png")
```
...
```{r fig.cap= "Human sex rate (right image) and population of African descent (left image) in Oaxaca municipalities, Mexico", echo = F, out.width = 600}
knitr::include_graphics("images/1_histograms.png")
```
...
```{r fig.cap= "Population of African descent(left image) and human sex rate (right image) in Oaxaca municipalities, Mexico", echo = F, out.width = 600}
knitr::include_graphics("images/1_themaps.png")
```
...
```{r fig.cap= "Population of African descent in selected municipalities", echo = F, out.width = 600}
knitr::include_graphics("images/1_selection.png")
```
...
```{r fig.cap= "Moran index of population of African descent (left image) and human sex rate (right image)", echo = F, out.width = 600}
knitr::include_graphics("images/1_moran.png")
```
